...
\section bee2evp-belt Алгоритмы СТБ 34.101.31 (belt)
...
шифрования (AEAD). При установке защиты имитовставка добавляется к данным,
при снятии защиты -- проверяется. Дополнительные открытые (ассоциированные)
